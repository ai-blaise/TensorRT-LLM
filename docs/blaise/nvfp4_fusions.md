...
direct win. Three fusions land here:
...
- **WarpDecode** (`warpdecode.md`): #13 fuses the pre-MoE norm+quant; WarpDecode
  is the expert GEMM. Independent stages of the MoE decode path.
